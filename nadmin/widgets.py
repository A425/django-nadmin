...
class AdminDateWidget(forms.DateInput):
    ...
    @property
    def media(self):
        return vendor('datepicker.js', 'datepicker.css', 'nadmin.widget.datetime.js')
...
class AdminTimeWidget(forms.TimeInput):
    ...
    @property
    def media(self):
        return vendor('datepicker.js','timepicker.js', 'timepicker.css', 'nadmin.widget.datetime.js')
...
class AdminSelectWidget(forms.Select):
    ...
    @property
    def media(self):
        return vendor('select.js', 'select.css', 'nadmin.widget.select.js')
