...
from nadmin.layout import FormHelper, Layout, Fieldset, Container, Column, Field, Col, TabHolder
from nadmin.util import unquote, lookup_field, display_for_field, boolean_icon, label_for_field
...
class DetailAdminView(ModelAdminView):
    ...
    def get_media(self):
        ...
        media.add_css({'screen': [self.static('nadmin/css/nadmin.form.css')]})
        return media
