...
from nadmin.util import static, json, vendor, sortkeypicker
...
class BaseAdminView(BaseAdminObject, View):
    ...
    base_template = 'nadmin/base.html'
...
class CommAdminView(BaseAdminView):
    ...
    base_template = 'nadmin/base_site.html'
    menu_template = 'nadmin/includes/sitemenu_default.html'
...
class ModelAdminView(CommAdminView):
    ...
    def get_template_list(self, template_name):
        ...
        return (
            ...
            "nadmin/%s/%s" % (opts.app_label, template_name),
            "nadmin/%s" % template_name,
        )
