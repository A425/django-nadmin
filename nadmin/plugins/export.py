...
from nadmin.util import json
from nadmin.views.list import ALL_VAR
...
class ExportMenuPlugin(BaseAdminPlugin):
    ...
    def block_top_toolbar(self, context, nodes):
        if self.list_export:
            ...
            nodes.append(loader.render_to_string('nadmin/blocks/model_list.top_toolbar.exports.html', context_instance=context))
