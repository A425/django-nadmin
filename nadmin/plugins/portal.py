...
from nadmin.views import BaseAdminPlugin, ModelFormAdminView, DetailAdminView
from nadmin.layout import Fieldset, Column
...
class BasePortalPlugin(BaseAdminPlugin):
    ...
    def get_media(self, media):
        return media + self.vendor('nadmin.plugin.portal.js')
