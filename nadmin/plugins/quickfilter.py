...
from nadmin.filters import manager,MultiSelectFieldListFilter
from nadmin.plugins.filters import *
...
class QuickFilterMultiSelectFieldListFilter(MultiSelectFieldListFilter):
    ...
    """
    template = 'nadmin/filters/quickfilter.html'
...
class QuickFilterPlugin(BaseAdminPlugin):
    ...
    def get_media(self, media):
        return media + self.vendor('nadmin.plugin.quickfilter.js','nadmin.plugin.quickfilter.css')
    ...
    def block_left_navbar(self, context, nodes):
        nodes.append(loader.render_to_string('nadmin/blocks/modal_list.left_navbar.quickfilter.html',context))
