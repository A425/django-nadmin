...
from nadmin.layout import Field, render_field
from nadmin.plugins.inline import Inline
from nadmin.plugins.actions import BaseActionView
from nadmin.plugins.inline import InlineModelAdmin
from nadmin.sites import site
from nadmin.util import unquote, quote, model_format_dict
from nadmin.views import BaseAdminPlugin, ModelAdminView, CreateAdminView, UpdateAdminView, DetailAdminView, ModelFormAdminView, DeleteAdminView, ListAdminView
from nadmin.views.base import csrf_protect_m, filter_hook
from nadmin.views.detail import DetailAdminUtil
...
class RevisionListView(BaseReversionView):
    ...
    @filter_hook
    def get_media(self):
        return super(RevisionListView, self).get_media() + self.vendor('nadmin.plugin.revision.js', 'nadmin.form.css')
...
class BaseRevisionView(ModelFormAdminView):
    ...
    @filter_hook
    def get_media(self):
        return super(BaseRevisionView, self).get_media() + self.vendor('nadmin.plugin.revision.js')
