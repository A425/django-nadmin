...
from nadmin.views.dashboard import ModelBaseWidget, widget_manager
from nadmin.util import lookup_field, label_for_field, force_unicode, json
...
class ChartWidget(ModelBaseWidget):
    ...
    template = 'nadmin/widgets/chart.html'
    ...
    # Media
    def media(self):
        return self.vendor('flot.js', 'nadmin.plugin.charts.js')
...
class ChartsPlugin(BaseAdminPlugin):
    ...
    def get_media(self, media):
        return media + self.vendor('flot.js', 'nadmin.plugin.charts.js')
    ...
    def block_results_top(self, context, nodes):
        ...
        nodes.append(loader.render_to_string('nadmin/blocks/model_list.results_top.charts.html', context_instance=context))
