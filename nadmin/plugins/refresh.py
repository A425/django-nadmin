...
class RefreshPlugin(BaseAdminPlugin):
    ...
    def get_media(self, media):
        if self.refresh_times and self.request.GET.get(REFRESH_VAR):
            media = media + self.vendor('nadmin.plugin.refresh.js')
        return media
    ...
    def block_top_toolbar(self, context, nodes):
        if self.refresh_times:
            ...
            nodes.append(loader.render_to_string('nadmin/blocks/model_list.top_toolbar.refresh.html', context_instance=context))
