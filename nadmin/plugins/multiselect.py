...
from nadmin.util import vendor
from nadmin.views import BaseAdminPlugin, ModelFormAdminView
...
class SelectMultipleTransfer(forms.SelectMultiple):
    ...
    @property
    def media(self):
        return vendor('nadmin.widget.select-transfer.js', 'nadmin.widget.select-transfer.css')
    ...
    def render(self, name, value, attrs=None, choices=()):
        ...
        return mark_safe(loader.render_to_string('nadmin/forms/transfer.html', context))
...
class SelectMultipleDropdown(forms.SelectMultiple):
    ...
    @property
    def media(self):
        return vendor('multiselect.js', 'multiselect.css', 'nadmin.widget.multiselect.js')
...
nadmin.site.register_plugin(M2MSelectPlugin, ModelFormAdminView)
