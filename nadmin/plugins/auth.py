...
from nadmin.layout import Fieldset, Main, Side, Row, FormHelper
from nadmin.sites import site
from nadmin.util import unquote, User
from nadmin.views import BaseAdminPlugin, ModelFormAdminView, ModelAdminView, CommAdminView, csrf_protect_m
...
class ChangePasswordView(ModelAdminView):
    ...
    def get_media(self):
        ...
        media = media + self.vendor('nadmin.form.css', 'nadmin.page.form.js') + self.form.media
        return media
    ...
    def get_response(self):
        return TemplateResponse(self.request, [
            ...
            'nadmin/auth/user/change_password.html'
