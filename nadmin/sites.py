...
class AdminSite(object):
    ...
    def __init__(self, name='nadmin'):
        self.name = name
        self.app_name = 'nadmin'
    ...
    def register_modelview(self, path, admin_view_class, name):
        from nadmin.views.base import BaseAdminView
    ...
    def register_plugin(self, plugin_class, admin_view_class):
        from nadmin.views.base import BaseAdminPlugin
    ...
    def get_plugins(self, admin_view_class, *option_classes):
        from nadmin.views import BaseAdminView
        plugins = []
    ...
    def i18n_javascript(self, request):
        ...
        return javascript_catalog(request, packages=['django.conf', 'nadmin'])
